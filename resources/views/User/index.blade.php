    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-9 d-none d-lg-block">
          @isset($user)
          <a href="#" class="small mr-3"> Welcome {{ $user->first_name }}</a>
      @endisset
         
        </div>
        <div class="col-lg-3 text-right">
          <a href="{{ route('user.create') }}" class="small mr-3"><span class="icon-unlock-alt"></span> Log In</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="owl-slide-3 owl-carousel">
                <div class="course-1-item">
                  ...
                  <div class="course-1-content pb-4">
                    ...
                    <p>
                      <a href="{{ route('course.show', 'Software Engineering') }}" class="btn btn-primary px-4 rounded-0">Learn More</a>
                  </p>
                  </div>
                </div>
                ...
                <div class="course-1-item">
                  ...
                  <div class="course-1-content pb-4">
                      ...
                      <p>
                        <a href="{{ route('course.show', 'Network Engineering') }}" class="btn btn-primary px-4 rounded-0">Learn More</a>
                    </p>
              ...
              <div class="course-1-item">
                ...
                <div class="course-1-content pb-4">
                    ...
                    <p>
                      <a href="{{ route('course.show', 'Computer Engineering') }}" class="btn btn-primary px-4 rounded-0">Learn More</a>
                  </p>
